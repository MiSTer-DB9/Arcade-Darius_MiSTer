...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Darius_MiSTer.git"
CORE_NAME=(Darius)
...
UPSTREAM_CORE_NAME=(Darius)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Darius.qpf)
COMPILATION_OUTPUT=(output_files/Darius.rbf)
